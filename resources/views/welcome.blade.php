                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-4 w-11/12 mx-auto justify-items-center py-8">
                        <a href="#" class="text-gray-800 pb-10">
                            <div class="w-32 h-32 rounded-full bg-blue-300 border-8 border-white z-20  relative flex items-center pl-6 mx-auto">
                        ...
                        <a href="#" class="pb-10">
                            <div>
                                <div class="w-32 h-32 rounded-full bg-blue-300 border-8 border-white z-30 relative flex items-center pl-6 justify-items-center mx-auto">
                ...
                <div class="md:flex justify-between w-4/5 mx-auto relative z-50">
                    ...
                    <div class="bg-white w-full mt-16 md:mt-0 md:w-1/3 py-8 px-5 rounded-md">
                        <form action="">
                            ...
                            <input type="submit" value="Submit" class="py-3 w-full rounded-lg  bg-blue-200">
                        </form>
                    </div>
                </div>
            </section>
