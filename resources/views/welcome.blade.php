...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    >
                ...
                <div class="flex justify-between items-center w-11/12 mx-auto py-8 text-white" :class="{'text-white': !scrollFromTop, 'text-gray-800': scrollFromTop}">
                    ...
                    <nav class="md:block hidden">
                        <ul class="flex items-center">
                            <li>
                                <a href="#" class="pr-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Home</a>
                            </li>
                            <li>
                                <a href="#" class="pr-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">About</a>
                            </li>
                            <li>
                                <a href="#" class="pr-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Our Services</a>
                            </li>
                            <li>
                                <a href="#" class="pr-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Resources</a>
                            </li>
                            <li>
                                <a href="#" class="pr-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Contact</a>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="hidden" :class="{'hidden': !navbarOpen, 'block': navbarOpen}">
                        <ul class="bg-white inset-x-8 z-50 fixed text-blue-400 pb-20 rounded-md top-28">
                            <li>
                                <a href="#" class="block pt-6 pl-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Home</a>
                            </li>
                            <li>
                                <a href="#" class="block pt-6 pl-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">About</a>
                            </li>
                            <li>
                                <a href="#" class="block pt-6 pl-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Our Services</a>
                            </li>
                            <li>
                                <a href="#" class="block pt-6 pl-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Resources</a>
                            </li>
                            <li>
                                <a href="#" class="block pt-6 pl-5 font-semibold text-lg tracking-wide hover:text-blue-500 transition ease-in duration-500">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <main>
            <section class="py-12">
                <div>
                    <h2 class="text-center text-4xl font-medium">About Us</h2>
                    <div class="grid md:grid-cols-4 w-11/12 mx-auto justify-items-center py-8">
                        <a href="#" class="text-gray-800 pb-10">
                            ...
                            <div class="pt-16 pb-4 bg-gray-100 px-7 -mt-14">
                                <p class="text-2xl font-semibold">1. Our Team</p>
                            </div>
                        </a>
                        <a href="#" class="pb-10">
                            <div>
                                ...
                                <div class="pt-16 pb-4 bg-gray-100 px-7 -mt-14">
                                    <p class="text-2xl mt-2 font-semibold">2. Our Processes</p>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="pb-10">
                            <div>
                                ...
                                <div class="pt-16 pb-4 bg-gray-100 px-7 -mt-14">
                                    <p class="text-2xl mt-2 font-semibold">3. Our Philosophy</p>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="pb-10">
                            <div>
                                ...
                                <div class="pt-16 pb-4 bg-gray-100 px-7 -mt-14">
                                    <p class="text-2xl mt-2 font-semibold">4. Who we serve</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="w-11/12 mx-auto grid md:grid-cols-2 justify-items-center py-8 text-white">
                        <div class="flex pb-20 md:pb-0">
                            ...
                            <div class="pl-4 md:pr-7">
                                <h3 class="text-3xl pb-7 font-semibold tracking-wider">Financial Planning</h3>
                                <p class="tracking-wide text-gray-200">We'll work to analyse your unique financial situation and provide easy-to -understand recommendation for your business.</p>
                            </div>
                        </div>
                        <div class="flex pb-20">
                            ...
                            <div class="pl-4 md:pr-7">
                                <h3 class="text-2xl md:text-3xl pb-7 font-semibold tracking-wider">Retirement Planning</h3>
                                <p class="tracking-wide text-gray-200">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi neque voluptatibus corrupti, itaque porro voluptatum rem accusamus et laborum iure? Aspernatur optio et pariatur minus eveniet vel. Atque, vero officia!</p>
                            </div>
                        </div>
                        <div class="flex pb-20 md:pb-0">
                            <div class="w-40">
                            ...
                            <div class="pl-4 md:pr-7">
                                <h3 class="text-3xl pb-7 font-semibold tracking-wider">Estate Planning</h3>
                                <p class="tracking-wide text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima aliquid saepe asperiores cum facilis, inventore fuga eaque beatae dolores ullam architecto sapiente eius. Veritatis voluptates magnam quas deserunt saepe harum?</p>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="w-40">
                            ...
                            <div class="pl-4 md:pr-7">
                                <h3 class="text-3xl pb-7 font-semibold tracking-wider">Investment Planning</h3>
                                <p class="tracking-wide text-gray-200">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio velit minus illo laudantium totam. Repellendus accusantium assumenda, labore autem facilis quas dicta minima eveniet mollitia adipisci impedit neque eligendi itaque.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="py-12 text-center bg-gray-200">
                ...
                <a href="#" class="py-4 px-8 rounded-3xl bg-blue-300  text-base md:text-lg font-semibold hover:bg-blue-500 hover:text-white transition ease-in duration-300">Schedule a time to talk</a>
            </section>
            <section class="py-12">
            ...
            <div class="z-30 inset-0 absolute bg-black opacity-80"></div>
                ...
                <div class="md:flex justify-between w-4/5 mx-auto relative z-40">
                    <div class="text-gray-200 text-lg tracking-wider">
                        ...
                        <div>
                            <h3>Opening hours:</h3>
                            <p>Monday - Fridays - 8:00 - 23:00</p>
                            <p>Saturdays - Sundays - 12:00 - 16:00</p>
                        </div>
                    </div>
